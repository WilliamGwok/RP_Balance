...
A_ballance = subs(A_ballance,[g,R,L,Lm,l,Mw,Mp,M,Iw,Ip,Im], [9.81,  0.1,  0.25,  0.25,  0.05,  2,  7,  10,  0.01,  0.1516,  0.3417]);
B_ballance = subs(B_ballance,[g,R,L,Lm,l,Mw,Mp,M,Iw,Ip,Im], [9.81,  0.1,  0.25,  0.25,  0.05,  2,  7,  10,  0.01,  0.1516,  0.3417]);
...
%Iw = 0.5*Mw*Rw*Rw
%Ip = (1/12)*Mp*(a^2 + b^2) a,b为长宽0.1 0.5
%Im = (1/12)*Mp*(a^2 + b^2) a,b为长宽0.5，0.4
